...
import '@0xstoryhunt/v3-core/contracts/interfaces/callback/IStoryHuntV3FlashCallback.sol';
import '@0xstoryhunt/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the StoryHunt V3 flash function
contract PairFlash is IStoryHuntV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `storyHuntV3FlashCallback`
