...
import '@0xstoryhunt/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IStoryHuntV3SwapCallback, PeripheryImmutableState {
    ...
    function storyHuntV3SwapCallback(
        ...
        IStoryHuntV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IStoryHuntV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
