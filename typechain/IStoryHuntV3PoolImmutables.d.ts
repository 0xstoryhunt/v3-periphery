...
interface IStoryHuntV3PoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3PoolImmutables extends Contract {
  ...
  interface: IStoryHuntV3PoolImmutablesInterface;
