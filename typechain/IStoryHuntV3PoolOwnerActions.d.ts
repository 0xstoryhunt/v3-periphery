...
interface IStoryHuntV3PoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3PoolOwnerActions extends Contract {
  ...
  interface: IStoryHuntV3PoolOwnerActionsInterface;
