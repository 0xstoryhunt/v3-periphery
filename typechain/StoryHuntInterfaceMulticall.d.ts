...
interface StoryHuntInterfaceMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class StoryHuntInterfaceMulticall extends Contract {
  ...
  interface: StoryHuntInterfaceMulticallInterface;
