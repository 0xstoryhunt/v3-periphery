...
interface IStoryHuntV3PoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3PoolDerivedState extends Contract {
  ...
  interface: IStoryHuntV3PoolDerivedStateInterface;
