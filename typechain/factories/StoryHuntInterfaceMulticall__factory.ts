...
import type { StoryHuntInterfaceMulticall } from "../StoryHuntInterfaceMulticall";

export class StoryHuntInterfaceMulticall__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<StoryHuntInterfaceMulticall> {
    return super.deploy(
      overrides || {}
    ) as Promise<StoryHuntInterfaceMulticall>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): StoryHuntInterfaceMulticall {
    return super.attach(address) as StoryHuntInterfaceMulticall;
  }
  connect(signer: Signer): StoryHuntInterfaceMulticall__factory {
    return super.connect(signer) as StoryHuntInterfaceMulticall__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StoryHuntInterfaceMulticall {
    return new Contract(
      address,
      _abi,
      signerOrProvider
    ) as StoryHuntInterfaceMulticall;
  }
}
  ...
  },
  {
    inputs: [
      {
        ...
        internalType: "struct StoryHuntInterfaceMulticall.Call[]",
        name: "calls",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct StoryHuntInterfaceMulticall.Result[]",
        name: "returnData",
        type: "tuple[]",
      },
    ],
