...
interface IStoryHuntV3PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class IStoryHuntV3PoolEvents extends Contract {
  ...
  interface: IStoryHuntV3PoolEventsInterface;
