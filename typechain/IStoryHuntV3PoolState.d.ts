...
interface IStoryHuntV3PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3PoolState extends Contract {
  ...
  interface: IStoryHuntV3PoolStateInterface;
