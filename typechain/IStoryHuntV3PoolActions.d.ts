...
interface IStoryHuntV3PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IStoryHuntV3PoolActions extends Contract {
  ...
  interface: IStoryHuntV3PoolActionsInterface;
