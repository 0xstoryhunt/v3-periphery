...
interface TestStoryHuntV3CalleeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestStoryHuntV3Callee extends Contract {
  ...
  interface: TestStoryHuntV3CalleeInterface;
